...
const [showBooking, setShowBooking] = useState(false);
  ...
  const mockReviews = [
    {
      ...
      name: "Sarah Johnson",
      rating: 5,
      comment: "Exceptional service! The team was professional, punctual, and exceeded my expectations. Highly recommended!",
      date: "2 weeks ago"
    },
    {
      id: 2,
      name: "Michael Chen", 
      rating: 4,
      comment: "Great experience overall. Quality work and fair pricing. Will definitely use their services again.",
      date: "1 month ago"
    },
    {
      id: 3,
      ...
      rating: 5,
      comment: "Outstanding attention to detail and customer service. They went above and beyond to ensure everything was perfect.",
      date: "2 months ago"
    }
  ];
  ...
  if (!service) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center px-4 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="bg-white rounded-2xl shadow-xl p-12 max-w-md">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">No Service Data</h2>
          <p className="text-gray-600 mb-8">Please go back and select a service again.</p>
          <button
            onClick={() => navigate('/')}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8">
              ...
              <div className="flex items-center text-gray-600 mb-2">
                ...
                <span className="text-lg">{service.address || "123 Business District, Professional Plaza"}</span>
              </div>
            ...
            {/* Description */}
            <div className="bg-white rounded-3xl shadow-xl p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">About Our Services</h2>
              <div className="prose prose-gray max-w-none">
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  We are dedicated to providing exceptional service that exceeds your expectations. Our team of experienced professionals combines industry expertise with personalized attention to deliver results that matter.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  With years of experience in the industry, we understand what it takes to deliver quality results on time and within budget. Our commitment to excellence and customer satisfaction sets us apart from the competition.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Whether you're looking for a one-time service or ongoing support, we're here to help you achieve your goals with professionalism and reliability you can trust.
                </p>
              </div>
            </div>
